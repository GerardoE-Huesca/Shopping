...
namespace Shopping.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IUserHelper userHelper, DataContext context, ICombosHelper combosHelper, IBlogHelper blobHelper)
        {
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (!ModelState.IsValid)
            {
                await LoadCombosAsync(model); // Carga las listas si el modelo no es válido
                return View(model);
            }
            ...
            // Si algo falla en el login, recarga los combos
            await LoadCombosAsync(model);
            return View(model);
        }

        // Método auxiliar para cargar los combos
        private async Task LoadCombosAsync(AddUserViewModel model)
        {
