    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return View(await _context.Countries
                .Include(c => c.States)
                .ToListAsync()); //Es como decir "Select * from countries" en la base de datos.
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            Country country = await _context.Countries
                .Include(c => c.States)
                .FirstOrDefaultAsync(c => c.Id == id); //Busca el findAsync por clave primaria o id
            if (country == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteState(int? id)
        {
            ...
            State state = await _context.States
                .Include(s => s.Country)
                .FirstOrDefaultAsync(s => s.Id == id); //Busca el findAsync por clave primaria o id
            if (state == null)
            {
                return NotFound();
            }
